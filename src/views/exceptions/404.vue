<template>
  <el-row :gutter="120">
    <el-col :span="12">
      <svg viewBox="0 0 52 52" style="enable-background:new 0 0 52 52;" height="200">
    ...
    <el-col :span="12">
      <h1>404</h1>
      <p>抱歉，没有找到此页面。</p>
      <el-button icon="fas fa-fw fa-arrow-alt-circle-left" @click="$router.go(-1)">返回上级</el-button>
      <el-button icon="fas fa-fw fa-house-damage" type="primary" @click="$router.push('/')">回到首页</el-button>
    </el-col>
  </el-row>
</template>
